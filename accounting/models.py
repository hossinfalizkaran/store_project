...
# ========================================
# مدل کاربر سفارشی برای احراز هویت
# ========================================
...
class LegacyUserManager(BaseUserManager):
    def create_user(self, username, password=None):
        # ما هرگز کاربری ایجاد نمی‌کنیم، اما این متد باید وجود داشته باشد
...
class LegacyUser(models.Model):
    # این فیلدها از دیتابیس legacy خوانده می‌شوند
    id = models.IntegerField(primary_key=True, db_column='Id')
    name = models.CharField(max_length=50, unique=True, db_column='Name')
    
    # ***** خط جدید و بسیار مهم *****
    # این فیلد را برای خواندن ستون Pass از دیتابیس اضافه می‌کنیم
    ...
    # این فیلد برای جنگو ضروری است تا بداند کدام فیلد به عنوان نام کاربری استفاده می‌شود
    USERNAME_FIELD = 'name'

    # این فیلدها هنگام ایجاد کاربر با createsuperuser پرسیده می‌شوند (ما از آن استفاده نمی‌کنیم)
    REQUIRED_FIELDS = []
    ...
    def set_password(self, raw_password):
        # این متد برای سازگاری با Django لازم است
        pass
    ...
    # این متدها برای پنل ادمین جنگو لازم هستند
    ...
    class Meta:
        # مهم‌ترین بخش: به جنگو می‌گوییم این مدل را مدیریت نکند
        managed = False
        db_table = 'Users' # مستقیم به جدول Users اشاره می‌کنیم
